...
export const categories: Category[] = [
  {
    ...
    children: [
      ...
      { id: '1-4', title: 'ساعت هوشمند و مچ‌بند', slug: 'smartwatch', parentId: '1' },
      { id: '1-5', title: 'هدفون، هدست و هندزفری', slug: 'headphone', parentId: '1' },
      { id: '1-6', title: 'اسپیکر', slug: 'speaker', parentId: '1' },
      { id: '1-7', title: 'کنسول بازی', slug: 'console', parentId: '1' },
      { id: '1-8', title: 'لوازم جانبی موبایل', slug: 'mobile-accessory', parentId: '1' },
    ],
  },
  {
    id: '2',
    ...
    icon: '🏠',
    children: [
      { id: '2-1', title: 'یخچال و فریزر', slug: 'refrigerator', parentId: '2' },
      { id: '2-2', title: 'ماشین لباسشویی', slug: 'washing-machine', parentId: '2' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: '4-4', title: 'مکمل‌های غذایی', slug: 'supplements', parentId: '4' },
    ],
  },
  {
    id: '5',
